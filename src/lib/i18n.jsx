...
export const translations = {
  pl: {
    ...
    cta: {
      ...
      b2cDesc: "Bez rejestracji. Wynik w kilka sekund.",
      b2cCta: "Już wkrótce",
    ...
    footer: {
      ...
      legalLabel: "Prawne",
      legalLinks: ["RODO", "Polityka Prywatności", "Warunki Korzystania"],
  ...
  en: {
    ...
    cta: {
      ...
      b2cTitle2: "best self?",
      b2cDesc: "No registration. Result in seconds.",
      b2cCta: "Coming Soon",
      b2bBadge: "For Clinics",
    ...
    footer: {
      ...
      legalLabel: "Legal",
      legalLinks: ["GDPR", "Privacy Policy", "Terms of Service"],
